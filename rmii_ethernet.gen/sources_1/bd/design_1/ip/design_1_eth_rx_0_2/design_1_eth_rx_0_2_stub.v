...
//               c:/Users/ameen.shaikh/Desktop/projects/rmii_ethernet/rmii_ethernet.gen/sources_1/bd/design_1/ip/design_1_eth_rx_0_2/design_1_eth_rx_0_2_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_eth_rx_0_2,eth_rx,{}" *) (* core_generation_info = "design_1_eth_rx_0_2,eth_rx,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=eth_rx,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* ip_definition_source = "module_ref" *) (* x_core_info = "eth_rx,Vivado 2025.2" *) 
module design_1_eth_rx_0_2(i_ref_clk, i_rxd, i_rxer, i_crs_dv, axi_aclk, 
  axi_aresetn, S_AXI_AWADDR, S_AXI_AWPROT, S_AXI_AWVALID, S_AXI_AWREADY, S_AXI_WDATA, 
...
/* synthesis syn_black_box black_box_pad_pin="i_rxd[1:0],i_rxer,i_crs_dv,axi_aresetn,S_AXI_AWADDR[31:0],S_AXI_AWPROT[2:0],S_AXI_AWVALID,S_AXI_AWREADY,S_AXI_WDATA[31:0],S_AXI_WSTRB[3:0],S_AXI_WVALID,S_AXI_WREADY,S_AXI_BRESP[1:0],S_AXI_BVALID,S_AXI_BREADY,S_AXI_ARADDR[31:0],S_AXI_ARPROT[2:0],S_AXI_ARVALID,S_AXI_ARREADY,S_AXI_RDATA[31:0],S_AXI_RRESP[1:0],S_AXI_RVALID,S_AXI_RREADY,M_AXI_AWADDR[31:0],M_AXI_AWLEN[7:0],M_AXI_AWSIZE[2:0],M_AXI_AWBURST[1:0],M_AXI_AWPROT[2:0],M_AXI_AWVALID,M_AXI_AWREADY,M_AXI_WDATA[31:0],M_AXI_WSTRB[3:0],M_AXI_WLAST,M_AXI_WVALID,M_AXI_WREADY,M_AXI_BRESP[1:0],M_AXI_BVALID,M_AXI_BREADY" */
/* synthesis syn_force_seq_prim="i_ref_clk" */
/* synthesis syn_force_seq_prim="axi_aclk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 i_ref_clk CLK" *) (* x_interface_mode = "slave i_ref_clk" *) (* x_interface_parameter = "XIL_INTERFACENAME i_ref_clk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_i_ref_clk, INSERT_VIP 0" *) input i_ref_clk /* synthesis syn_isclock = 1 */;
  input [1:0]i_rxd;
  input i_rxer;
  input i_crs_dv;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 axi_aclk CLK" *) (* x_interface_mode = "slave axi_aclk" *) (* x_interface_parameter = "XIL_INTERFACENAME axi_aclk, ASSOCIATED_BUSIF M_AXI:S_AXI, ASSOCIATED_RESET axi_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_1_clk_out1, INSERT_VIP 0" *) input axi_aclk /* synthesis syn_isclock = 1 */;
