...
HD_PWD='C:/Users/ameen.shaikh/Desktop/projects/rmii_ethernet/rmii_ethernet.runs/design_1_eth_rx_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_eth_rx_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_eth_rx_0_2.tcl
